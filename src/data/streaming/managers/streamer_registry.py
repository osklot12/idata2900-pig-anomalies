...
class StreamerRegistry:
    ...
    def __init__(self):
        ...
        self._streamers = ConcurrentDict[str, ProducerStreamer]()
    ...
    def get_streamer(self, streamer_id: str) -> ProducerStreamer:
        """
        Returns the streamer with the given id.

        Returns:
            Producer: The streamer with the given id.
        """
    ...
    def _get_streamers(self) -> ConcurrentDict[str, ProducerStreamer]:
        """
    ...
    def _add_streamer(self, streamer: ProducerStreamer) -> str:
        """
        Adds a streamer to the manager, creating a unique id for it.

        Args:
            streamer (Producer): The streamer to be added.
