...
class FileStreamerPairProvider(StreamerPairProvider):
    ...
    def __init__(self, instance_provider: InstanceProvider, entity_factory: DatasetEntityProvider,
        ...
        Args:
            ...
            entity_factory (DatasetEntityProvider): a factory for creating the dataset entities
    ...
    def create_streamer_pair(self, frame_consumer: Feedable[Frame], annotations_consumer: Feedable[FrameAnnotations]
        ...
        if instance:
            video = self._entity_factory.get_video_file(instance.video_file)
            annotations = self._entity_factory.get_annotations_file(instance.annotation_file)
