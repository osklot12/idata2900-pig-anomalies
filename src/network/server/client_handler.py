...
class ClientHandler:
    ...
    def handle(self) -> None:
        ...
        while recv_raw_msg and self._running:
            ...
            print(f"[ClientHandler] Got request {recv_msg} from '{self._session.get_client_address()}'")
            ...
            print(f"[ClientHandler] Sent response {response} to '{self._session.get_client_address()}'")
